	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BumpMap22 = IN.ase_texcoord7.xy;
				float3 TangentNormal18 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap22 ), 1.0f );
				
				float2 uv_EmissionMap30 = IN.ase_texcoord7.xy;
				float4 EmissionColor32 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap30 ) * _EmissionColor ) : float4( 0,0,0,0 ) );
				float2 temp_cast_1 = (_UVTilling).xx;
				float2 texCoord85_g189 = IN.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float2 uvsmatrixeffect38_g196 = texCoord85_g189;
				float widthmatrixeffect41_g196 = _Width;
				float2 temp_output_4_0_g196 = ( uvsmatrixeffect38_g196 / widthmatrixeffect41_g196 );
				float mulTime6_g196 = _TimeParameters.x * _TimeScale;
				float2 break24_g197 = uvsmatrixeffect38_g196;
				float mulTime20_g197 = _TimeParameters.x * _DropSpeed;
				...
				float2 appendResult19_g189 = (float2(WorldPosition.x , WorldPosition.y));
				float2 appendResult12_g189 = (float2(WorldPosition.z , WorldPosition.z));
				...
				float mulTime6_g194 = _TimeParameters.x * _TimeScale;
				float2 break24_g195 = uvsmatrixeffect38_g194;
				float mulTime20_g195 = _TimeParameters.x * _DropSpeed;
				...
				float3 normalizeResult7_g189 = normalize( abs( WorldNormal ) );
				...
				float2 appendResult20_g189 = (float2(WorldPosition.z , WorldPosition.y));
				float2 appendResult14_g189 = (float2(WorldPosition.x , WorldPosition.x));
				float2 SideUvs32_g189 = ( ( appendResult20_g189 + sin( appendResult14_g189 ) ) * _UVTilling );
				float2 uvsmatrixeffect38_g192 = SideUvs32_g189;
				float widthmatrixeffect41_g192 = _Width;
				float2 temp_output_4_0_g192 = ( uvsmatrixeffect38_g192 / widthmatrixeffect41_g192 );
				float mulTime6_g192 = _TimeParameters.x * _TimeScale;
				float2 break24_g193 = uvsmatrixeffect38_g192;
				float mulTime20_g193 = _TimeParameters.x * _DropSpeed;
				...
				float2 appendResult15_g189 = (float2(WorldPosition.x , WorldPosition.z));
				float2 appendResult11_g189 = (float2(WorldPosition.y , WorldPosition.y));
				float2 BackUvs34_g189 = ( ( appendResult15_g189 + sin( appendResult11_g189 ) ) * _UVTilling );
				float2 uvsmatrixeffect38_g190 = BackUvs34_g189;
				float widthmatrixeffect41_g190 = _Width;
				float2 temp_output_4_0_g190 = ( uvsmatrixeffect38_g190 / widthmatrixeffect41_g190 );
				float mulTime6_g190 = _TimeParameters.x * _TimeScale;
				float2 break24_g191 = uvsmatrixeffect38_g190;
				float mulTime20_g191 = _TimeParameters.x * _DropSpeed;
				...
				#endif
				float4 MatrixOut50 = ( staticSwitch67_g189 * _MatrixColor );
				
				float2 uv_MetallicTexture417 = IN.ase_texcoord7.xy;
				...
				float2 uv_OcclusionMap28 = IN.ase_texcoord7.xy;
				float OcclusionMap26 = tex2D( _OcclusionMap, uv_OcclusionMap28 ).r;
				
				float Alpha33 = AlbedoColor25.a;
				
				float AlphaClipThreshold24 = _Cutoff;
				
				float3 Albedo = AlbedoColor25.rgb;
				float3 Normal = TangentNormal18;
				float3 Emission = ( EmissionColor32 + MatrixOut50 ).rgb;
				float3 Specular = 0.5;
				float Metallic = MetallicValue13;
				float Smoothness = SmoothnessValue17;
				float Occlusion = OcclusionMap26;
				float Alpha = Alpha33;
				float AlphaClipThreshold = AlphaClipThreshold24;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_MainTex19 = IN.ase_texcoord2.xy;
				float4 tex2DNode19 = tex2D( _MainTex, uv_MainTex19 );
				float4 AlbedoColor25 = ( tex2DNode19 * _Color );
				float Alpha33 = AlbedoColor25.a;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_EmissionMap30 = IN.ase_texcoord2.xy;
				float4 EmissionColor32 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap30 ) * _EmissionColor ) : float4( 0,0,0,0 ) );
				float2 temp_cast_1 = (_UVTilling).xx;
				float2 texCoord85_g189 = IN.ase_texcoord2.xy * temp_cast_1 + float2( 0,0 );
				float2 uvsmatrixeffect38_g196 = texCoord85_g189;
				float widthmatrixeffect41_g196 = _Width;
				float2 temp_output_4_0_g196 = ( uvsmatrixeffect38_g196 / widthmatrixeffect41_g196 );
				float mulTime6_g196 = _TimeParameters.x * _TimeScale;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_MainTex19 = IN.ase_texcoord3.xy;
				float4 tex2DNode19 = tex2D( _MainTex, uv_MainTex19 );
				float4 AlbedoColor25 = ( tex2DNode19 * _Color );
				float Alpha33 = AlbedoColor25.a;
...
/*ASEBEGIN
Version=18935
403;73;1592;529;1424.536;1342.807;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;9;-952.8609,-505.6901;Inherit;False;1242.73;2053.751;;34;4;2;6;3;7;0;5;13;17;33;18;24;32;26;28;23;27;34;22;35;31;25;29;15;10;16;21;30;20;19;49;417;418;419;Standard Inputs;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;408;-1005.206,-1249.375;Inherit;False;807.866;425.3186;;3;291;305;50;Matrix Effect Implementation;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;30;-833.6708,878.0277;Inherit;True;Property;_EmissionMap;Emission Texture;26;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;16;-788.1799,1069.461;Inherit;False;Property;_EmissionColor;Emission Color;27;1;[HDR];Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;20;-872.2498,166.795;Inherit;False;Property;_Color;Color;18;0;Create;True;0;0;0;True;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;19;-902.8608,-24.62833;Inherit;True;Property;_MainTex;Albedo;16;2;[NoScaleOffset];[SingleLineTexture];Create;False;1;PBR Settings;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;291;-973.5483,-1004.856;Inherit;False;Property;_MatrixColor;Matrix Color;1;1;[HDR];Create;True;0;0;0;False;0;False;0.9098039,2.980392,0.5176471,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;427;-862.3057,-1067.375;Inherit;False;MatrixEffectTriplanar;2;;189;a7f3f0914b1d1304e9f79bd817894b2d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-445.6333,882.5367;Inherit;False;Property;_UseEmission;UseEmission;25;1;[Toggle];Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;417;-835.1136,424.291;Inherit;True;Property;_MetallicTexture;Metallic Texture;19;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;418;-636.4467,670.7469;Inherit;False;Property;_MetallicValue;Metallic Value;20;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-459.1212,-136.7804;Inherit;False;Property;_Glossiness;Smoothness Value;21;0;Create;False;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;305;-544.8671,-963.0187;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;22;-807.9371,1288.142;Inherit;True;Property;_BumpMap;Normal Texture;23;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;28;-826.4652,-455.6901;Inherit;True;Property;_OcclusionMap;Occlusion Map;24;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-859.6588,-217.3625;Inherit;False;Property;_Cutoff;Alpha Clip Threshold;17;0;Create;False;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;411;144.5974,-1101.488;Inherit;False;Property;_MatrixEditorStart;Matrix Editor Start;0;1;[HideInInspector];Create;True;0;0;0;True;3;Foldout(MatrixEffect,true,8);;Space;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;39;899.592,-487.1311;Inherit;False;25;AlbedoColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;38;1101.045,72.99792;Inherit;False;Property;_AdvancedInpector;AdvancedInpector;29;1;[HideInInspector];Create;True;0;0;0;True;2;;DrawSystemProperties;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;412;345.427,-1102.559;Inherit;False;Property;_MatrixEditorEnd;Matrix Editor End;14;1;[HideInInspector];Create;True;0;0;0;False;2;Space;EndGroup();False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;36;-181.1218,1282.373;Inherit;False;Property;_EditorStart;Editor Start;15;1;[HideInInspector];Create;True;0;0;0;True;3;Foldout(Main,true,8);;Space;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;1173.896,-314.0344;Float;False;True;-1;2;MarkupAttributes.Editor.MarkedUpShaderGUI;0;2;Matrix Metallic LIT;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;638020332164026087;Surface;0;638020329970648676;  Refraction Model;0;638011973672971937;  Blend;2;638011973777688074;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-783.3929,80.43769;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=BAA3CB913D20BAF012A4591AE601301567626202